...
const TITLE = "Geck: Classic Home (Agentic Commerce)";
...
/** Previous homepage — kept at /v1 after the VersionHome redesign became `/`. */
    ...
    <>
      <JsonLd
        data={[
          ...
          breadcrumbJsonLd([
            { name: "Home", path: "/" },
            { name: "Classic", path: "/v1" },
          ]),
        ]}
      />
      <main className="min-w-0 overflow-x-hidden bg-surface text-ink">
        <HomeHero headingId="v1-hero-heading" testId="classic-home-hero" />
